...
## load function which trains model and calculates model performance metrics
source("function.R")
...
plot.roc(result$status,as.numeric(result$pred.rf),percent = T,
         add=T,print.auc = T,print.auc.y = 40,col="#4daf4a")
