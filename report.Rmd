...
The curve (AUC) for the logistical LASSO model and random forest are 85.7% and 97.4%  respectively. From the figure we note that for most thresholds random forest performs better than the logistic LASSO model at classifying individuals with and without ASD.  
